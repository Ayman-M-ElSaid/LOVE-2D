...
A LÖVE2D (Lua) implementation of Flappy Bird inspired by Lecture 0 of CS50's Introduction to Game Development (CS50 2D) — flap through procedurally spawned pipes as the pace ramps up with your score.
